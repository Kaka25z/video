...
import com.video.core.config.filter.JwtAuthenticationTokenFilter;
        ...
        return http
                ...
                .authorizeRequests(authorize -> authorize
                        ...
                        .antMatchers("/druid/**","/favicon.ico",
                                ...
                                "/video/latest",
                                "/captcha/**",
                                "/video/user-recent-coins",
                                "/video/get-by-main-category",
                                "/video/ranked-details",
                                "/user/follow/get-all").permitAll()
                        // 允许HTTP OPTIONS请求
