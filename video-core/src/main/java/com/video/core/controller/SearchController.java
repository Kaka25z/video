...
public class SearchController {
    ...
    @PostMapping("/search/hot/delete")
    public CustomResponse deleteHotSearch(@RequestParam("keyword") String keyword) {
        CustomResponse customResponse = new CustomResponse();
        customResponse.setData(searchService.deleteHotSearch(keyword));
        return customResponse;
    }
}
