...
public class DirectVideoUploadConsumer {
     ...
     */
    @RabbitHandler
    public void handleMergeChunks(String jsonPayload) throws IOException, InvalidKeyException, NoSuchAlgorithmException, IllegalArgumentException, MinioException {
