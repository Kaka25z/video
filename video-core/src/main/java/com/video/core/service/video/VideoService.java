...
public interface VideoService {
    ...
    List<Map<String, Object>> getVideosWithDataAndUidByIdsOrderByDesc(List<Integer> idList, @Nullable String column, Integer page, Integer quantity, Integer uid);
    ...
    CustomResponse updateVideoInfo(Integer vid, Video videoInfo, MultipartFile cover);

    List<Video> getAllVideosOrderByUploadDate();

    List<Map<String, Object>> getDailyVideoUploadCount();

    Map<String, Object> getSummary();

    List<Integer> getVideoIdsByUid(Integer uid);

    List<Integer> getVideosByMainCategory(String mcId, String scId);

    void calculateAndStoreVideoScore();

    List<Map<String, Object>> getVideoScore();

    void updateVideoScore(Integer vid, Double newScore);

    void deleteVideoScore(Integer vid);

    List<Map<String, Object>> getCategoryVideoCounts();

    List<Map<String, Object>> getRankedVideosWithDetails(Integer start, Integer end);
