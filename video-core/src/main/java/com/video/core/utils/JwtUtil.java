...
public class JwtUtil {
    ...
    public static final String JWT_KEY = "bEn2xiAnG0mU2KaKa25za0YOu5HzH0hE1CwJ1GOnG1tOnG6kAifAwAnchEnG";
    ...
    public String createToken(String uid, String role) {
        ...
        String token = Jwts.builder()
                ...
                .setIssuer("https://api.kaka25zai.fun")
                .setAudience("https://www.kaka25zai.fun")
