        ...
        <div class="login-wrapper">
            ...
            <div class="login-container">
                <div class="form-box">
                    ...
                    <div class="input-box-verify">
                        <i class="iconfont icon-yanzhengma"></i>
                        <input type="text" v-model="verifyCode">
                        <label>验证码</label>
                        <img class="verify-img" :src="verifyImg" alt="验证码" @click="getVerifyCode">
                    </div>
...
export default {
    ...
    methods: {
        ...
        async getVerifyCode() {
            ...
            if (!res.data) return;
            this.verifyImg = res.data.data.image;
            this.verifyKey = res.data.data.key;
        },
        ...
        async VerifyCode() {
            ...
            formData.append("key", this.verifyKey);
...
.input-box-verify input:focus~label, .label-up {
    top: -5px !important;
}

.input-box-verify input {
