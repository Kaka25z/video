                    ...
                    <div class="user-info-card flex_start">
                        ...
                        <div class="user-content">
                            ...
                            <div class="card-buttom">
                                <button class="not-follow" v-if="!followStatus[item.uid]">+ 关注</button>
    ...
    async mounted() {
        if (this.userList.length > 0) {
            for (let user of this.userList) {
                await this.checkFollow(user.uid);
            }
        }
    },
    methods: {
        ...
        async followUser(uid) {
            ...
            if (res.data.code === 200) {
                ...
                this.followStatus[uid] = true;
            }
        },

        async checkFollow(followUid) {
            if (!this.$store.state.user.uid) {
                this.$set(this.followStatus, followUid, false);
                return false;
            }
            ...
            this.followStatus[followUid] = isFollowing;
            return isFollowing;
        },
