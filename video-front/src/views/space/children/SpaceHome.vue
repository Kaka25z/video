        ...
        <div class="col-1">
            ...
            <div class="section video">
                <h3 class="section-title">
                    <span class="t" @click="$router.push(`/space/${uid}/video`)">{{ this.$store.state.user.uid === uid ?
                        "我" :
                        "TA" }}的视频</span>
                    <span class="count">{{ videoCount }}</span>
                    <span class="more" @click="$router.push(`/space/${uid}/video`)">更多<i
                    ...
                    <div class="be-tab" v-if="videoCount > 1">
                        ...
                        <div class="be-tab-cursor" :style="`transform: translateX(${63 * (rule - 1)
                            }px); width: 48px;`"></div>
                    </div>
                </h3>
                <div class="video-content">
                    <div class="small-item" v-for="(item, index) in videoList" :key="index">
                        ...
                        <a :href="`/video/${item.video.vid}`" target="_blank" class="title" :title="item.video.title">{{
                            item.video.title }}</a>
                        <div class="meta">
                            <span class="play" v-if="item.stats">
                                <svg t="1711216187515" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="4408" id="mx_n_1711216187515" width="14"
                                    height="14">
                                    <path
            ...
            <div class="section fav">
                <h3 class="section-title">
                    <span class="t" @click="$router.push(`/space/${uid}/favlist`)">{{
                        this.$store.state.user.uid === uid ? "我" : "TA"
                        }}的收藏夹</span>
                    <span class="count">{{ favList.length }}</span>
                    <span class="more" @click="$router.push(`/space/${uid}/favlist`)">更多<i
                            class="iconfont icon-youjiantou"></i></span>
                </h3>
                <div class="fav-content">
                    <div v-for="(item, index) in favList" :key="index">
                        <div class="fav-item" v-if="
                            item.visible === 1 || item.uid === this.$store.state.user.uid
                        ">
                            ...
                            <div class="m">
                                ...
                                <a class="name" :title="item.title"
                                    @click="$router.push(`/space/${uid}/favlist?fid=${item.fid}`)">{{
                                    item.title }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section love">
                ...
                <div class="love-content">
                    <div class="small-item" v-for="(item, index) in loveVideos" :key="index">
                        ...
                        <a :href="`/video/${item.video.vid}`" target="_blank" class="title" :title="item.video.title"
                            v-if="item.video.status === 1">{{ item.video.title }}</a>
                        ...
                        <div class="meta">
                            ...
                            <span class="danmu" v-if="item.video.status === 1">
                                <svg t="1711224902593" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="4273" width="14" height="14">
                                    <path
                                        d="M800 128H224C134.4 128 64 198.4 64 288v448c0 89.6 70.4 160 160 160h576c89.6 0 160-70.4 160-160V288c0-89.6-70.4-160-160-160z m96 608c0 54.4-41.6 96-96 96H224c-54.4 0-96-41.6-96-96V288c0-54.4 41.6-96 96-96h576c54.4 0 96 41.6 96 96v448z"
                                        p-id="4274"></path>
                                    <path
            ...
            <div class="section coin">
                ...
                <div class="coin-content">
                    <div class="small-item" v-for="(item, index) in coinVideos" :key="index">
                        <a :href="`/video/${item.video.vid}`" target="_blank" class="cover">
                          <img v-if="item.video.coverUrl" :src="item.video.coverUrl" alt="" />
                        ...
                        <div class="meta">
                          <span class="play" v-if="item.stats">
                            <svg t="1711216187515" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4408" id="mx_n_1711216187515" width="14" height="14">
                              <path d="M800 128H224C134.4 128 64 198.4 64 288v448c0 89.6 70.4 160 160 160h576c89.6 0 160-70.4 160-160V288c0-89.6-70.4-160-160-160z m96 608c0 54.4-41.6 96-96 96H224c-54.4 0-96-41.6-96-96V288c0-54.4 41.6-96 96-96h576c54.4 0 96 41.6 96 96v448z" p-id="4409"></path>
                              <path d="M684.8 483.2l-256-112c-22.4-9.6-44.8 6.4-44.8 28.8v224c0 22.4 22.4 38.4 44.8 28.8l256-112c25.6-9.6 25.6-48 0-57.6z" p-id="4410"></path>
                            </svg>
                            <span class="num">{{ handleNum(item.stats.play) }}</span>
                          </span>
...
export default {
    ...
    methods: {
        ...
        async getCoinVideos() {
            const res = await this.$get("/video/user-recent-coins", {
                params: {
                    uid: this.uid,
                    offset: 0,
                    quantity: 20,
