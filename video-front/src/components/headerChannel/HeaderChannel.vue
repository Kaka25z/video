<template>
    <div class="header-channel">
        ...
        <div class="channel-icons">
            ...
            <div class="channel-icons__item" @click="openNewPage(`/v/popular`)">
        ...
        <div class="right-channel-container">
            ...
            <div class="channel-items__left" v-if="channels.length != 0">
                ...
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;">
                    ...
                    <template #content>
                        <div class="channel-children-container">
                            <div class="sub-item" v-for="subIndex in Math.ceil(channels[0].scList.length / 4)"
                                :key="subIndex">
                                <div @click="openNewPage(`/v/${child.mcId}/${child.scId}`)" class="channel-children"
                ...
                <div class="channel-link" @click="noPage">
                    <span>电影</span>
                </div>
                <!-- 国创 -->
                <VPopover class="channel-link" placement="top" popStyle="z-index: 2000; cursor: default;">
                    ...
                    <template #content>
                        <div class="channel-children-container">
                            <div class="sub-item" v-for="subIndex in Math.ceil(channels[1].scList.length / 4)"
                                :key="subIndex">
                                <div @click="openNewPage(`/v/${child.mcId}/${child.scId}`)" class="channel-children"
                ...
                <!-- 将剩下的遍历出来 -->
                <VPopover class="channel-link" v-for="(item, index) in channels.slice(2)" :key="index"
                    :placement="index % 2 == 0 ? 'top' : 'bottom'" popStyle="z-index: 2000; cursor: default;">
                    <template #reference>
                    ...
                    <template #content>
                        <div class="channel-children-container">
                            <div class="sub-item" v-for="subIndex in Math.ceil(item.scList.length / 4)" :key="subIndex">
                                <div @click="openNewPage(`/v/${child.mcId}/${child.scId}`)" class="channel-children"
                                    v-for="(child, chIndex) in item.scList.slice(
                                        (subIndex - 1) * 4,
                                        subIndex * 4
                                    )" :key="chIndex">
                                    {{ child.scName }}
                ...
                <VPopover placement="bottom" popStyle="z-index: 2000;" @mouseenter="isOpen = true"
                    ...
                    <template #content>
                        <div class="more-channel-popover__wrap">
                            ...
                            <div class="more-channel" @click="noPage">
                                <span>公益</span>
                            </div>
                            <div class="more-channel" @click="noPage">
                                <span>公开课</span>
